...
def music():
    ...
    pygame.mixer.music.play()
def risada():
    pygame.mixer.music.load("risadadomal.mp3")
    pygame.mixer.music.play()
def naruto():
    pygame.mixer.music.load("naruto.mp3")
    pygame.mixer.music.play()
...
def colisão(car,vel0, correr0, passou=False):
    global velocidade, velocidade2, velocidade3, correr, correr2, correr3
    if passou:
        if car == carro:
            velocidade = vel0
            correr = correr0
...
while janela_aberta:
    pygame.time.delay(50) #a cada 50 milisegundos o programa vai executar tudo isso aqui
